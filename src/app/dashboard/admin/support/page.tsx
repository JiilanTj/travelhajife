...
export default function SupportPage() {
  ...
  const renderChatInterface = () => {
    // Return early if no conversation is selected
    ...
    <DashboardLayout>
      <div className="container px-4 mt-10">
        <div className="mb-6">
          ...
          <p className="text-gray-600">Kelola percakapan dengan pengguna</p>
        </div>
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-xl shadow-sm p-10 text-center">
            ...
            <p className="text-gray-500">
              Belum ada percakapan yang dimulai oleh pengguna.
            </p>
          </div>
        ) : (
